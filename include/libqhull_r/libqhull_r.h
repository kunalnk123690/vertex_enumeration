...
#include <libqhull_r/user_r.h>      /* user definable constants (e.g., realT). */

#include <libqhull_r/mem_r.h>   /* Needed for qhT in libqhull_r.h */
#include <libqhull_r/qset_r.h>   /* Needed for QHULL_LIB_CHECK */
...
#include <libqhull_r/stat_r.h>  /* needs boolT */
